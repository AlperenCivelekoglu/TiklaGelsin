...
namespace TiklaGelsin.ViewModels
{
    public class LoginViewModel : BaseViewModel
    {
        ...
        private int _DavetKodu;
        public int DavetKodu
        {
            set
            {
                this._DavetKodu = value;
                OnPropertyChanged();
            }
            get
            {
                return this._DavetKodu;
            }
        }
        ...
        private async Task RegisterCommandAsync()
        {
            ...
            try
            {
                ...
                Result = await userService.RegisterUser(Username, Password, Ad, Soyad, EMail, PhoneNo, DavetKodu);
                if (Result)
                {
